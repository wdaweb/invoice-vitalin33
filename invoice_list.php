    ...
    <div class="float-right bg-white vh-100 " style="width:45vw; padding:40px 5% 0 5%">
        <p class="pb-3" style="font-size:1.6rem; color:#333;text-align:center; font-weight:600; ">● 您已登錄的發票清單 ●</p>
            ...
            <div class="row justify-content-around" style="list-style-type: none;padding:0;">
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-1">1、2月</a></button></li>                
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-2">3、4月</a></button></li>
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-3">5、6月</a></button></li>
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-4">7、8月</a></button></li>
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-5">9、10月</a></button></li>
                <li><button class="btn btn-warning mb-2"><a href="?do=invoice_list&pd=2020-6">11、12月</a></button></li>
    </div>
...
<table class="table text-center float-right ">
   ...
   if($page>1){
    ...
    ?>
        ...
        echo "<p>&nbsp;&nbsp;&nbsp;&nbsp;<a href='?do=invoice_list&pd=2020-".$period."&page=1'>首頁&nbsp;&nbsp;&nbsp;</a></p>";
        $prepage=$_GET['page']-1;
