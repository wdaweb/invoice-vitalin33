...
<body>
    <div class="container mainmenu  ">
        <div class="sidebar">
            <header style="color:#836e61;"><i class="fas fa-crown fa-3x pb-2" style=" -webkit-text-stroke: 2px rgb(114, 105, 4);"></i><br>統一發票管理系統</header>
                <ul class="p-0">
                    <div class="row justify-content-center signSet">
                    <p><a href="?do=logout" class=" d-flex d-inline-block small">LOG OUT</a></p>
        ...
        <div class="styleSideMenu p-0 text-center">
                    ...
                    <li><a href="?do=invoice_list&pd=<?=date("Y");?>-<?=$period;?>&page=1" target="mainindex">已登錄發票清單</a></li>
