...
?>
        <div class="d-block bg-white" style="padding:40px 10% 0 15%; padding-top:40px; height:100vh;">
        ...
        <tbody>
         <tr> 
          <th class="addawards" id="months">年月份</th> 
        ...
        ?> 月 </td> 
         ...
         <tr> 
          <th class="addawards" id="special_prize" rowspan="2">特別獎</th> 
         ...
         <tr> 
          <th class="addawards" id="grand_prize" rowspan="2">特獎</th> 
         ...
         <tr> 
          <th class="addawards" id="first_prize" rowspan="2">頭獎</th> 
         ...
         <tr> 
          <th class="addawards"  id="addSix_prize">增開六獎</th> 
       ...
       <button class="btn btn-primary mx-auto">
           <a href="?do=award_all&year=<?=$year?>&period=<?=$period?>" class="text-light text-decoration-none text-center">對獎</a>  <!--網址帶參數的東西，網址盡量不要拆開-->
        </button>
